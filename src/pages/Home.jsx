...
const Home = () => {
  ...
  return (
    <div>
      <div className="bg-blue-600 text-white h-[10vh] w-full fixed top-0 left-0 flex items-center px-10 justify-between">
        <div className="flex gap-3 items-center">
          <Lottie animationData={infinity} loop={true} className="w-16" />
          <h1 className="text-3xl font-bold">Pages</h1>
        </div>
        <p className="font-bold">A Collection of Works</p>
      </div>
